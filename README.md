...
![Forecast Fragility Score](assets/forecast-fragility-score.png)

### FedEx — Next Miss Simulation
![FedEx Next Miss Simulation](assets/next-miss-simulation-FedEx.png)

### Starbucks — Next Miss Simulation
![Starbucks Next Miss Simulation](assets/next-miss-simulation-starbucks.png)

### Internal Executive Memo View (Optional)
![Internal Memo](assets/internal-memo.png)
